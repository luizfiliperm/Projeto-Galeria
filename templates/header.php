    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbar-links">
            <div class="navbar-nav"> <!--Sugestivel a mudança-->
                ...
                <a href="#" class="nav-item nav-link" id="photos-menu">Fotos</a>
                <a href="#"class="nav-item nav-link" id="album-menu">Album</a>
                <a href="#"class="nav-item nav-link" id="about-menu">Sobre nos</a>
